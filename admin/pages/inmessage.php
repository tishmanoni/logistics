...
if(isset($_POST['uset'])){
 ...
 <label>Package Name </label>
     ...
     <label>Receiver's Email</label>
        ...
        <input type="text" name="status" placeholder=" e.g in transit, in warehouse, awaiting pickup"   class="form-control">
        </div>

     <div class="form-group">
     <label>Package Location</label>
        <input type="text" name="location" placeholder="Enter package location"  class="form-control">
        </div>
   ...
   <label>Package Service type</label>
        <input type="text" name="servicetype" placeholder="Package Service type"   class="form-control">
        </div>
